alert("Предупреждение: в минус можно уходить до -1000, далее вы проиграете, после обновления страницы прокачка автокликера будет утеряна!");
...
function reboot () {
  alert("Денег за нажатие " + updating + ". Ваш баланс " + score + " .");
}
